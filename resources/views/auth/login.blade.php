...
<div class="container">
    <div class="row justify-content-md-center">
        <div class="col-lg-6 col-md-8 form-wrapper">
            <h1 class="text-center text-white pb-5">LOGIN</h1>
            <form class="form form-inner-pad" method="POST" action="{{ route('login') }}">
                ...
                <label class="checkbox">
                    ...
                    <label for="anim-check" class="check-label">Remember Me</label>

                <button type="submit" class="btn submit-btn"><p>LOGIN</p></button>
                <div class="row">
