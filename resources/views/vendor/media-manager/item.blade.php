        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu">
                <li><a href="{{$item->getPublicPath()}}" download="{{$item->file}}"><i
                                class="fa fa-download"></i>{{trans('media-manager::admin.download_file')}}</a></li>
                {{--<li><a href="#"><i class="fa fa-pencil-square-o"></i> Редактирай</a></li>--}}
                <li><a href="#" class="file-rename"><i class="fa fa-pencil-square-o"></i>{{trans('media-manager::admin.rename_file')}}</a></li>
                <li><a href="#" class="edit-visibility"><i class="fa fa-eye-slash"></i>{{trans('media-manager::admin.description_visibility')}}</a></li>
                <li><a href="#"><i class="fa fa-code"></i>{{trans('media-manager::admin.embed')}}</a></li>
            </ul>
        </div>
    </div>
